      ...
      <v-col>
        <v-card>
          <v-form ref="form" @submit.prevent="submitForm" v-model="valid" class="pa-5" enctype="multipart/form-data">
            <v-text-field v-model="users.name" label="Nhập tên" :rules="NameU" required></v-text-field>
            <v-text-field v-model="users.address" label="Nhập quê quán" :rules="AddressU" required></v-text-field>
            ...
            <v-text-field v-model="users.email" label="Nhập email" :rules="EmailU" required></v-text-field>
